...
enum BFCC_ILangs : uint8_t { I_BF_BRAINFUCK, I_BF_TINYBF };

enum BFCC_OLangs : uint8_t { O_INTERPRET, O_BF_BRAINFUCK, O_FULL_C, O_FULL_GO, O_FULL_JAVA, O_FULL_PYTHON };
...
struct BFCC_Parameters {
	...
	// Optimization flags
	bool foperatorconcatination = true;
	bool fdeadcodeelimination   = true;
	bool flazymoves				= true;
	bool fmultiplyloop			= true;
	bool fscanloop				= true;
};
