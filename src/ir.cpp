...
std::vector<BFCC_Instruction>
BFCC_AST_to_IR::generate(std::vector<std::shared_ptr<BFCC_Node>> nodelist)
{
	for (auto i : nodelist) {
		i->accept(this);
	}
...
void
BFCC_AST_to_IR::visit(std::shared_ptr<BFCC_Node_DPTRmv> n)
{
...
void
BFCC_AST_to_IR::visit(std::shared_ptr<BFCC_Node_DATAadd> n)
{
...
void
BFCC_AST_to_IR::visit(std::shared_ptr<BFCC_Node_DATAprint> n)
{
...
void
BFCC_AST_to_IR::visit(std::shared_ptr<BFCC_Node_DATAget> n)
{
...
void
BFCC_AST_to_IR::visit(std::shared_ptr<BFCC_Node_CTRLLoop> n)
{
...
std::string
BFCC_IR_PPrint(std::vector<BFCC_Instruction> oplist)
{
